		...
		<div id="maincontent">
			...
			<div>
				...
				<tr>
					...
					<td>
					请选择状态：<s:select name="attendType" label="请选择状态：" labelposition="left" 
					...
					<table width="770px">
						...
						<td style="width:400px;font-size:14px;">
							<s:if test="currenPage>1">
								<a href="todayAttend.action?currenPage=<s:property value="currenPage-1"/>">上一页</a>
							</s:if>
						</td>
						<td style="width:400px;font-size:14px;">
							<s:if test="currenPage<maxPage">
							<a href="todayAttend.action?currenPage=<s:property value="currenPage+1"/>">下一页</a>
							</s:if>
						</td>
