                            ...
                            <ul class="list-group">
                              <li class="list-group-item">
                                <button class="menu-item-left" data-target="extrawork/extraworkList.jsp">
                                    <span class="glyphicon glyphicon-triangle-right"></span>加班信息查询
                                </button>
                              </li>
                              <li class="list-group-item">
                            ...
                            <ul class="list-group">
                              <li class="list-group-item">
                                ...
                                <button class="menu-item-left" data-target="salary.jsp">
                                    <span class="glyphicon glyphicon-triangle-right"></span>薪资汇总
                                </button>
                              </li>
                            </ul>
                        </div>
             ...
             假期情况管理
                        ...
                        <div id="collapseListGroup6" class="panel-collapse collapse" role="tabpanel" aria-labelledby="collapseListGroupHeading6">
                            <ul class="list-group">
                                ...
                                <c:if test="${sessionScope.emp.impRole=='经理' || sessionScope.emp.impRole =='副经理' }">
                              	  <li class="list-group-item">
	                                <button class="menu-item-left" data-target="attendace/applyHoliday.jsp">
	                                    <span class="glyphicon glyphicon-triangle-right"></span>假期审核
	                                </button>
	                              </li>
                                </c:if>
                               	<c:if test="${sessionScope.emp.impRole=='职工' }">
                               	  <li class="list-group-item">
	                                <button class="menu-item-left" data-target="attendace/applyHoliday.jsp">
                               	...
                               	<li class="list-group-item">
                               	 <button class="menu-item-left" data-target="attendace/applyHoliday.jsp">
	                                    <span class="glyphicon glyphicon-triangle-right"></span>个人请假信息查看
	                             </button>
	                             </li>
                               	</c:if>
                            </ul>
			...
			<form class="form-horizontal" action="addEmp.do" method="post" enctype="multipart/form-data">
				<fieldset>
					...
					<div class="form-group">
							<label class="control-label col-md-2 col-xs-2 col-sm-2">登录密码:</label>
							<div class="col-md-4 col-xs-4 col-sm-4">
					...
					<div class="form-group has-feedback">
						  ...
						  <div class="col-md-4 col-xs-4 col-sm-4 input-append date" id="datetimepicker" data-date-format="yyyy-mm-dd">
					        ...
					        <input class="form-control" size="16" type="text" name="birthday" value="${pageScope.date }" >
					...
					<div class="form-group">
							...
							<div class="col-md-4 col-xs-4 col-sm-4">
								<input type="text" name="telephone" value="${emp.tel }" class="form-control">
							</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
							...
							<div class="col-md-4 col-xs-4 col-sm-4">
								<input type="text" value="${emp.impRole }" class="form-control" readonly="readonly">
							</div>
					</div>
					<div class="form-group">
							<label class="control-label col-md-2 col-xs-2 col-sm-2">薪      资:</label>
							<div class="col-md-4 col-xs-4 col-sm-4">
								<input type="text" name="salary" value="${emp.salary }" class="form-control" disabled="disabled">
							</div>
					</div>
					</fieldset>
					<fieldset>
