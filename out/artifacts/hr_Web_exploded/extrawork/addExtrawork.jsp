...
<div class="row">
    ...
    <div id="content" class="col-md-10 col-xs-10 col-sm-10"
        ...
        <div>
            <form action="AddExtrawork" class="form-horizontal" style="margin-top: 20px;">
                ...
                <div class="form-group has-feedback">
                    <label class="control-label col-md-2 col-xs-2 col-sm-2">加班开始时间：</label>
                ...
                <div class="form-group has-feedback">
                    <label class="control-label col-md-2 col-xs-2 col-sm-2">加班结束时间：</label>
                    <div class="col-md-4 col-xs-4 col-sm-4 input-append date"
