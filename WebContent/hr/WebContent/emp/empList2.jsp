						...
						<td colspan="9" style="text-align: right;"> 
							<ul class="pagination">
								<c:if test="${pageInfo.currentPage-1>0}">
								    <li>
								      <a href="searchEmpByCondition.do?${condition}&currentPage=${pageInfo.currentPage-1 }&pageSize=7" aria-label="Previous">
							    ...
							    <c:forEach begin="1" end="${pageInfo.pageCount }" step="1" var="page">
							     ...
							     <c:if test="${pageInfo.currentPage+1 <= pageInfo.pageCount }">
								    <li>
								      <a href="searchEmpByCondition.do?currentPage=${pageInfo.currentPage+1 }&pageSize=7${condition==''?'':'&'}${condition}" aria-label="Next">
