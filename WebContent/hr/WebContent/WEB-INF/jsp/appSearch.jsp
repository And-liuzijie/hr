				...
				<s:iterator id="applyList" value="applyList" status="apply">
					<tr id="apply<s:property value="#apply.index"/>"
						...
						<td>
							...
							<a href="cheXiaoApply.action?currenPage=<s:property value="currenPage"/>&type=2&endTime=<s:property value="endTime"/>&oImpId=<s:property value="impId"/>&startTime=<s:property value="startTime"/>"><s:property value="holsState==0?'撤消':''"/></a>
